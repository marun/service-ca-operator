...
var map_CABundleInjectorConfig = map[string]string{
	"":             "CABundleInjectorConfig provides information to configure a CA Bundle Injector controller",
	"caBundleFile": "caBundleFile holds the ca bundle to inject",
}

func (CABundleInjectorConfig) SwaggerDoc() map[string]string {
	return map_CABundleInjectorConfig
}
...
var map_ServiceCertSignerOperatorConfigSpec = map[string]string{
	...
	"caBundleInjectorConfig":         "caBundleInjectorConfig holds a sparse config that the user wants for this component.  It only needs to be the overrides from the defaults it will end up overlaying in the following order: 1. hardcoded default 2. this config",
}

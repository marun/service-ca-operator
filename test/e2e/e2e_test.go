...
func TestE2E(t *testing.T) {
	...
	t.Run("rotate-CA", func(t *testing.T) {
		...
		// TODO(marun)
		// Collect service serving cert and key and ca bundle
		// Prompt rotation
		// Collect new service serving cert and ca bundle
		// Validate:
		// - original cert with original bundle
		// - new cert with old bundle
		// - old cert with new bundle
		// - new cert with new bundle
		...
		// Check that the new serving cert can be verified with the old ca bundle.

		// Check that the old serving cert can be verified with the new ca bundle.
